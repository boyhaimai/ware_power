import tl from "@/asset/Images/df2fd7411fa05be38b58022d6fbd493b.jpg";
    ...
    <section className="py-20 bg-gradient-to-br from-red-50 to-orange-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-[1.5rem] md:text-5xl font-black text-gray-900 mb-4">
            THỰC TRẠNG VIỆC GIÁO DỤC HƯỚNG NGHIỆP HIỆN NAY
          </h2>
          <p className="text-2xl text-red-600 font-bold">Trong Thực Tế</p>
        </div>
